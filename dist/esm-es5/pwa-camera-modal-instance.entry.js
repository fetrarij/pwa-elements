...
var PWACameraModal = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.handleOnRotate = function () {
            _this.el.rotate();
        };
        this.handleOnCapture = function () {
            _this.el.capture();
        };
    }
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "wrapper", onClick: function (e) { return _this.handleBackdropClick(e); } }, h("div", { class: "content" }, h("pwa-camera", { emballageImage: this.emballageImage, onClick: function (e) { return _this.handleComponentClick(e); }, facingMode: this.facingMode, handlePhoto: this.handlePhoto, handleOnRotate: this.handleOnRotate, handleOnCapture: this.handleOnCapture, handleNoDeviceError: this.handleNoDeviceError, noDevicesButtonText: this.noDevicesButtonText, noDevicesText: this.noDevicesText }))));
    };
